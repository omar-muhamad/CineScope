    ...
    <section className="relative w-full h-[25vh] md:h-[450px]">
      <div className="absolute w-full z-10 top-0 px-16 md:py-5 h-full flex gap-6">
        ...
        <div className="h-full md:mt-5 grow">
          <Skeleton className="h-8 md:h-10 w-2/3 max-w-md rounded mt-6" />
          <Skeleton className="h-4 w-1/3 max-w-xs rounded mt-4" />
          <Skeleton className="h-4 w-1/4 max-w-[12rem] rounded mt-3" />
          ...
          <div className="hidden md:block mt-4 max-w-[50vw]">
            ...
            <Skeleton className="h-3 w-11/12 rounded mt-2" />
