...
import { ROW_CARD_WIDTH } from "@/components/skeletons/SkeletonMediaRow";
...
/**
 * A titled, horizontally scrolling row of media cards. Presentational only —
 * loading is handled by a Suspense fallback above it (see MediaRowSkeleton).
 * Hides itself entirely when there are no items so an empty heading never
 * lingers.
 */
